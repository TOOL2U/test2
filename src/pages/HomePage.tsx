            ...
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap gap-4 animate-fadeIn" style={{ animationDuration: '500ms', animationDelay: '400ms' }}>
                ...
                <a
                  ...
                  className="border-2 border-[#FFD700] text-[#FFD700] px-8 py-4 rounded-lg font-bold text-lg hover:bg-[#FFD700]/10 transition-colors flex items-center"
                >
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-6 text-center text-white">
          <AnimateOnScroll>
            ...
            <Link 
              to="/categories"
              className="bg-[#FFD700] text-gray-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-[#FFE44D] transition-colors inline-flex items-center group"
            >
              Browse Tools 
              <ArrowRight className="ml-2 w-5 h-5 transform group-hover:translate-x-1 transition-transform" />
            </Link>
